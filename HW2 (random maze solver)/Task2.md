In this homework you are given a maze project where randomly behaving robot tries to reach tothe exit (end). Robot will be initially placed at start position.
